...
public class McpTools {
    ...
    public IotDeviceCreateResponse createDevice(
        ...
        return iotDeviceService.create(new IotDeviceCreateRequest(UUID.randomUUID().toString(), name, description,
    ...
    public IotDeviceListResponse listDevices(
        ...
        return iotDeviceService.list(new IotDeviceListRequest(UUID.randomUUID().toString(), name, iotDeviceModelId,
    ...
    public IotDeviceModelGetResponse getModel(
        ...
        return iotDeviceModelService
                .get(new IotDeviceModelGetRequest(UUID.randomUUID().toString(), new IotDeviceModelId(id)));
    }
    ...
    public IotDeviceModelListResponse listModels(
        ...
        return iotDeviceModelService
                .list(new IotDeviceModelListRequest(UUID.randomUUID().toString(), name, limit, page, sort, sortBy));
    }
    ...
    public String deleteModel(
        ...
        iotDeviceModelService
                .delete(new IotDeviceModelDeleteRequest(UUID.randomUUID().toString(), new IotDeviceModelId(id)));
